    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?= ADMIN ?>/feedback"><i class="fa fa-shopping-cart"></i> <span>Отзывы</span></a></li>
                <li><a href="<?= ADMIN ?>/schedule"><i class="fa fa-shopping-cart"></i> <span>Расписание</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
